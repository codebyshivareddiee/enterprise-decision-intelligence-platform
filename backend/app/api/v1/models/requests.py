...
class WorkflowExecuteRequest(BaseModel):
    ...
    workspace_id: UUID = Field(..., description="The workspace ID where the workflow should run.")
...
class WorkflowResumeRequest(BaseModel):
    ...
    feedback: str | None = Field(None, description="Optional feedback if rejected or modified.")
...
class DecisionOutcomeRequest(BaseModel):
    ...
    human_decision: str = Field(..., description="The actual decision made by the human.")
    feedback: str | None = Field(None, description="Additional feedback on why this decision was made.")
    final_outcome: str | None = Field(None, description="The observed real-world outcome (if known).")

...
class DocumentAnalysisResult(BaseModel):
    ...
    matched_schema_id: UUID | None = Field(default=None, description="The selected KnowledgeSchema ID.")
    chunking_strategy: str = Field(..., description="The selected chunking strategy (e.g. HeadingChunker).")
    ...
    detected_document_type: str | None = Field(default=None, description="Detected type of document.")
    detected_language: str | None = Field(default=None, description="Detected language.")
    estimated_complexity: str | None = Field(default=None, description="Estimated complexity (e.g. high, low).")
    requires_human_confirmation: bool = Field(default=False, description="Flag if human confirmation is required.")

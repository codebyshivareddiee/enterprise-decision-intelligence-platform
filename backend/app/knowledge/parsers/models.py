...
class ParsedDocument(BaseModel):
    ...
    filename: str | None = Field(default=None, description="The name of the original file.")
    extension: str | None = Field(default=None, description="The extension of the original file.")
    page_count: int | None = Field(default=None, description="The total number of pages.")
    ...
    headings: list[str] = Field(
        ...
        description="List of detected headings."
    )
    table_of_contents: str | None = Field(
        default=None, 
        description="Extracted table of contents, if any."
    )
    section_titles: list[str] = Field(
        default_factory=list, 
        description="Extracted section titles."
    )

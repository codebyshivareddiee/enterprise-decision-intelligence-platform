...
from app.workflow import WorkflowState, AgentRegistry, ExecutionContext, WorkflowRuntime
from app.agents.planner.schemas import ExecutionPlan, ExecutionStep, AgentType, WorkflowArtifact, FailureStrategy
...
def setup_mock_registry() -> AgentRegistry:
    ...
    def mock_retriever(state: WorkflowState) -> dict:
        ...
        return {"retrieved_chunks": ["chunk1", "chunk2"]}
    ...
    def mock_reasoning(state: WorkflowState) -> dict:
        ...
        return {"reasoning_result": {"status": "analyzed"}}
    ...
    def mock_recommendation(state: WorkflowState) -> dict:
        ...
        return {"recommendation": {"id": 123, "score": 95}}
    ...
    def mock_explanation(state: WorkflowState) -> dict:
        ...
        return {"explanation": "This candidate is highly recommended."}
...
def create_test_plan(requires_review: bool = False, trigger_replan: bool = False) -> ExecutionPlan:
    ...
    steps = [
        ...
        ExecutionStep(
            ...
            failure_strategy=FailureStrategy.REPLAN if trigger_replan else FailureStrategy.FAIL_PLAN
        ),
        ExecutionStep(
...
def test_normal_execution():
    ...
    context = ExecutionContext(plan=plan, state=WorkflowState(), registry=registry, planner=Planner())
